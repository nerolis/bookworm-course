import { 
  ...
  FETCH_ONE_DREAM_REQUEST_SUCCES
} from '../types';
...
export const fetchOneDream = dreamId => ({
  type: FETCH_ONE_DREAM_REQUEST,
  dreamId
});

export const fetchOneDreamSucces = dream => ({
  type: FETCH_ONE_DREAM_REQUEST_SUCCES,
  dream
});